    ...
    <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-8">
            ...
            <div>
              ...
              <a
                href="mourito10@gmail.com" className="text-muted hover:text-primary transition-colors">
                mourito10@gmail.com
              </a>
            </div>
            ...
            <div>
              ...
              <a
                href="tel:7003489273" className="text-muted hover:text-primary transition-colors">
               7003489273
              </a>
            </div>
            ...
            <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/ritobrata-dey-675a2525a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app ">
                    <Linkedin/>
                </a>
         ...
         <div>
          ...
          <div>
            ...
            <input type="email" id="email" name="email" required className="w-full px-4 py-3 rounded-md border-input bg-background focus:outlind-hidden focus:ring-2 focus:ring-primary"
                placeholder="ritobrata@gmail.com"
            />
         </div>
          <div>
